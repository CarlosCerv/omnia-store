                ...
                <div className="flex min-h-screen">
                    ...
                    <aside className="w-80 border-r border-nordic-border flex flex-col fixed inset-y-0 z-50 bg-white">
                        ...
                        <div className="p-10 border-t border-nordic-border space-y-4">
                            ...
                            <button className="w-full flex items-center gap-4 px-6 py-4 text-nordic-muted hover:text-red-500 transition-all font-bold text-[11px] uppercase tracking-widest">
                                <LogOut size={18} />
